...
const assets = {
  ...
  left: createImage('https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/1.png'), // Bulbasaur
  right: createImage('https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/9.png'), // Blastoise
};
...
function updateBall(delta) {
  ...
  if (ball.x + ball.size < 0) {
    score.right += 1;
    pointOver('Blastoise scores!');
  } else if (ball.x > COURT.width) {
    score.left += 1;
    pointOver('Bulbasaur scores!');
  }
}
